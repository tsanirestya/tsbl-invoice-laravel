...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .nav-section {
            color: rgba(255,255,255,.22); font-size: .6rem; font-weight: 700;
            letter-spacing: 1.5px; text-transform: uppercase;
            padding: .8rem 1.4rem .25rem;
        }
        #sidebar .nav-link {
...
<nav id="sidebar">
    ...
    <div class="sidebar-scroll">
        <div class="nav-section">Manajemen Billing</div>
        ...
        <a href="{{ route('dsi.batches.index') }}" class="nav-link {{ request()->routeIs('dsi.*') ? 'active' : '' }}">
            <i class="bi bi-file-earmark-spreadsheet-fill"></i> DSI Manager
        </a>
        <a href="{{ route('reconciliations.index') }}" class="nav-link {{ request()->routeIs('reconciliations.*') ? 'active' : '' }}">
            <i class="bi bi-arrow-repeat"></i> Reconciliations
        </a>
        <a href="{{ route('billing-payments.index') }}" class="nav-link {{ request()->routeIs('billing-payments.*') ? 'active' : '' }}">
            <i class="bi bi-bank2"></i> Billing Payments
        </a>

        <div class="nav-section">Menu Utama (Legacy)</div>
        <a href="{{ route('dashboard') }}" class="nav-link {{ request()->routeIs('dashboard') ? 'active' : '' }}">
            <i class="bi bi-grid-1x2-fill"></i> Dashboard
        </a>
        <a href="{{ route('invoices.index') }}" class="nav-link {{ request()->routeIs('invoices.*') ? 'active' : '' }}">
            <i class="bi bi-file-earmark-text-fill"></i> Invoice Old
        </a>
        @php
